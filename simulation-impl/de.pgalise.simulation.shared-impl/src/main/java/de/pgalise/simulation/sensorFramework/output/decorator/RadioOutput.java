...
public class RadioOutput extends OutputDecorator{
	...
	public void transmitBoolean(boolean value) throws IllegalStateException {
		this.getSensorOutput().transmitBoolean(this.random.nextDouble() <= 0.01 ? !value : value);
	}
	...
	public void transmitByte(byte value) throws IllegalStateException {
		...
		this.getSensorOutput().transmitByte((byte) (this.random.nextBoolean() ? value + diff : value - diff));
	}
	...
	public void transmitShort(short value) throws IllegalStateException {
		...
		this.getSensorOutput().transmitShort((short) (this.random.nextBoolean() ? value + diff : value - diff));
	}
	...
	public void transmitInt(int value) throws IllegalStateException {
		...
		this.getSensorOutput().transmitInt(this.random.nextBoolean() ? value + diff : value - diff);
	...
	public void transmitLong(long value) throws IllegalStateException {
		...
		this.getSensorOutput().transmitLong(this.random.nextBoolean() ? value + diff : value - diff);
	...
	public void transmitFloat(float value) throws IllegalStateException {
		...
		this.getSensorOutput().transmitFloat(this.random.nextBoolean() ? value + diff : value - diff);
	}

	@Override
	public void transmitDouble(double value) throws IllegalStateException {
		final double diff = this.random.nextFloat() * 0.1f;
		this.getSensorOutput().transmitDouble(this.random.nextBoolean() ? value + diff : value - diff);
	}
