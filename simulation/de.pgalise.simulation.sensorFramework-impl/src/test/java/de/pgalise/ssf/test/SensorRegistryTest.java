...
public class SensorRegistryTest {
	...
	public void testAddSensor() {
		...
		for (int i = 0; i < expected; i++) {
			this.sensorRegistry.addSensor(new TestSensor(i + 1, Vector2d.valueOf(i, i)));
		}
		// assert
	...
	public void testGetSensor() {
		...
		final Sensor sensor = new TestSensor(11, Vector2d.valueOf(887, 14));
	...
	public void testNumberOfSensors() {
		...
		for (int i = 0; i < 20; i++) {
			sensors.add(this.sensorRegistry.addSensor(new TestSensor(i + 1, Vector2d.valueOf(i, i))));
		}
		for (int i = 0; i < (sensors.size() - 2); i++) {
			this.sensorRegistry.removeSensor(sensors.get(i));
		}
		final Sensor sensor = new TestSensor(3, Vector2d.valueOf(12, 343));
		this.sensorRegistry.addSensor(sensor);
	...
	public void testRemoveSensor() {
		...
		final Sensor sensor = new TestSensor(11, Vector2d.valueOf(23, 8438));
		this.sensorRegistry.addSensor(sensor);
		this.sensorRegistry.removeSensor(sensor);
