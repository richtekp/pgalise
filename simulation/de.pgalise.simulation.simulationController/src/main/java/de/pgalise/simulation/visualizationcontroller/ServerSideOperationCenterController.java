 ...
 * @author Timo
 */
public interface ServerSideOperationCenterController extends VisualizationController, SensorManagerController<Event, StartParameter, InitParameter,Sensor<?,?>> {
