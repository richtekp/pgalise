 ...
 * @author Timo
 */
public interface ServerSideControlCenterController extends VisualizationController, Controller<Event, StartParameter, InitParameter>, SimulationComponent<Event> {
	/**
