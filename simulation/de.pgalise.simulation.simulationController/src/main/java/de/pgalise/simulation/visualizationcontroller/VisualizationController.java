...
/**
 * Interface for Control Center and Operation Center controller.
 * Both will get information from the simulation. E.g. if the
 * simulation is stopped, caused by errors.
 * @author Timo
 */
