...
/**
 * Weather parameter: perceived temperature
 * 
 * @author Andreas Rehfeldt
 * @version 1.0 (03.07.2012)
 */
public final class PerceivedTemperature extends WeatherParameterBase {
	 ...
	 *            WeatherService
	 */
	public PerceivedTemperature(WeatherService base) {
		super(base);
	}
	...
	public <T extends Number> T getValue(long time) throws NoWeatherDataFoundException {
		Float value = this.getWeather(time).getPerceivedTemperature();
		return (T) value;
	}
