...
/**
 * Weather parameter: precipitation amount
 * 
 * @author Andreas Rehfeldt
 * @version 1.0 (03.07.2012)
 */
public final class PrecipitationAmount extends WeatherParameterBase {
	 ...
	 *            WeatherService
	 */
	public PrecipitationAmount(WeatherService base) {
		super(base);
	}
	...
	public <T extends Number> T getValue(long time) throws NoWeatherDataFoundException {
		Float value = this.getWeather(time).getPrecipitationAmount();
		return (T) value;
	}
