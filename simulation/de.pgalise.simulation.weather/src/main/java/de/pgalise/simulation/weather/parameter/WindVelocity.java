...
/**
 * Weather parameter: wind velocity
 * 
 * @author Andreas Rehfeldt
 * @version 1.0 (03.07.2012)
 */
public final class WindVelocity extends WeatherParameterBase {
	/**
	 * Constructor
	 * 
	 * @param base
	 *            WeatherService
	 */
	public WindVelocity(WeatherService base) {
		super(base);
	}
	...
	public <T extends Number> T getValue(long time) throws NoWeatherDataFoundException {
		Float value = this.getWeather(time).getWindVelocity();
		return (T) value;
	}
