 ...
 * weather information. Due to the fact that the component should not allocate
 * too much space during runtime, it provides only a specific amount of modified
 * weather information. If there is a request for weather parameter values,
 * which cannot be calculated from the provided data, the {@link WeatherService}
 * try to get the needed data automatically.
 *
