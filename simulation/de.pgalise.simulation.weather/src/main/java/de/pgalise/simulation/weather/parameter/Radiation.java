...
/**
 * Weather parameter: radiation
 * 
 * @author Andreas Rehfeldt
 * @version 1.0 (03.07.2012)
 */
public final class Radiation extends WeatherParameterBase {
	 ...
	 *            WeatherService
	 */
	public Radiation(WeatherService base) {
		super(base);
	}
	...
	public <T extends Number> T getValue(long time) {
		Integer value = this.getWeather(time).getRadiation();
		return (T) value;
	}
