 ...
 */
public class BarometerWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_barometer_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public BarometerWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, BarometerWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
