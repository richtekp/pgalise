 ...
 */
public class WindFlagWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_windflag_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public WindFlagWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, WindFlagWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
