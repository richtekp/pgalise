 ...
 */
public class AnemometerWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_anemometer_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public AnemometerWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, AnemometerWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
