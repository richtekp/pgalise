 ...
 */
public class RainsensorWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_rainsensor_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public RainsensorWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, RainsensorWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
