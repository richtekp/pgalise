 ...
 * assumes that the space of {@link Long#MAX_VALUE } +
 * abs({@link Long#MIN_VALUE}) is never exhausted and doesn't provide any action
 * to react to this situation (due to performance reasons).
 *
 * @author richter
 */
@MappedSuperclass
