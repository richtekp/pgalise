...
public class SensorHelperWeather extends SensorHelper {
	...
	public SensorHelperWeather(Sensor<?> sensorID, Coordinate position, SensorTypeEnum sensorType, int weatherStationID, List<SensorInterfererType> sensorInterfererList) {
		super(sensorID, position, sensorType, sensorInterfererList);
	 ...
	 * @param nodeId
	 */
	public SensorHelperWeather(Sensor<?> sensorID, Coordinate position, SensorTypeEnum sensorType, int updateSteps,
			int weatherStationID, List<SensorInterfererType> sensorInterfererList) {
		this(sensorID, position, sensorType, weatherStationID, sensorInterfererList);
