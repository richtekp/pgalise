...
public class SensorHelperTrafficLightIntersection extends SensorHelper {
	...
	public SensorHelperTrafficLightIntersection(
			Sensor<?> sensorID, Coordinate position, List<Integer> trafficLightIds, List<SensorInterfererType> sensorInterfererList) {
		super(sensorID, position, SensorTypeEnum.TRAFFIC_LIGHT_INTERSECTION, sensorInterfererList);
