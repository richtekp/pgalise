...
public class BaseBoundaryTest {
  ...
  public void testRetrieveCenterPoint() {
    ...
    BaseBoundary instance = new BaseBoundary(idGenerator.getNextId(),
      testCity.getReferencePoint(),
      testCity.getBoundaryCoordinates());
    Coordinate expResult = 
      GeoToolsBootstrapping.getGeometryFactory().createMultiPoint(testCity.getBoundaryCoordinates().toArray(new Coordinate[testCity.getBoundaryCoordinates().size()])).getCentroid().getCoordinate();
  ...
  public void testRetrieveBoundary() {
    ...
    BaseBoundary instance = new BaseBoundary(idGenerator.getNextId(),
      ...
      testCity.getBoundaryCoordinates());
    Polygon expResult = 
      GeoToolsBootstrapping.getGeometryFactory().createPolygon(testCity.getBoundaryCoordinates().toArray(new Coordinate[testCity.getBoundaryCoordinates().size()]));
