 ...
 */
public class LuxmeterWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_luxmeter_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public LuxmeterWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, LuxmeterWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
