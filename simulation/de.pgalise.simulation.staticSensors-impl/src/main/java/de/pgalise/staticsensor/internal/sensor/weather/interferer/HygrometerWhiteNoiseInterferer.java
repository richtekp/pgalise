 ...
 */
public class HygrometerWhiteNoiseInterferer extends WeatherBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_hygrometer_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public HygrometerWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, HygrometerWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
