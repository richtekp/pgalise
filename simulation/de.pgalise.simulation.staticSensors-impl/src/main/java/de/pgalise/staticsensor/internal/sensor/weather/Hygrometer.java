 ...
 * @version 1.0
 */
public final class Hygrometer extends WeatherSensor {
	 ...
	 */
	public Hygrometer(final Output output, final Object sensorId, final Vector2d position,
	 ...
	 */
	public Hygrometer(Output output, Object sensorId, Vector2d position, WeatherController weatherController,
