...
/**
 * Implementation of an {@link TopoRadarInterferer} that hold several other {@link TopoRadarInterferer}s
 * 
 * @author Marcus
 * @version 1.0
 */
public final class CompositeTopoRadarInterferer implements TopoRadarInterferer {
	...
	/**
	 * Creates a {@link CompositeTopoRadarInterferer} with no composite {@link TopoRadarInterferer}s attached.
	 */
	...
	/**
	 * Creates a {@link CompositeTopoRadarInterferer} with the passed {@link TopoRadarInterferer}s attached.
	 * 
	 * @param interferers
	 *            the {@link CompositeTopoRadarInterferer}s to attach
	...
	/**
	 * Attaches an {@link TopoRadarInterferer} to this {@link CompositeTopoRadarInterferer}
	 * 
	 * @param interferer
	 *            the {@link TopoRadarInterferer} to be attached to this {@link CompositeTopoRadarInterferer}
	 * @return 'true' whether the passed {@link TopoRadarInterferer} could have been attached to this
	 *         {@link CompositeTopoRadarInterferer}, otherwise 'false'
	...
	/**
	 * Detaches the passed {@link TopoRadarInterferer} from this {@link CompositeTopoRadarInterferer}
	 * 
	 * @param interferer
	 *            the {@link TopoRadarInterferer} to be detached from this {@link CompositeTopoRadarInterferer}
	...
	public int[] interfere(final int mutableAxleCount, final int mutableLength, final int mutableWheelbase1,
		...
		for (final TopoRadarInterferer interferer : this.interferers) {
			result = interferer.interfere(result[0], result[1], result[2], result[3], simTime);
		}
