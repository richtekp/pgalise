...
@Stateful
public class DefaultEnergySensorController extends AbstractController<EnergyEvent, StartParameter, InitParameter>
  implements EnergySensorControllerLocal {

  private Set<EnergySensor> sensorRegistry = new HashSet<>();
