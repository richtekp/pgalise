...
/**
 * Abstract base class for all types of state those a {@link UdpOutput}
 * can adopt
 * @author marcus
 *
 */
abstract class UdpOutputState {

	/**
	 * holds the passed instance of the passed {@link UdpIpOutput} that
	 * can adopt the passed states
	 */
	private final UdpOutput output;
	 ...
	 */
	protected UdpOutputState(final UdpOutput output) throws IllegalArgumentException {
		if(output == null) {
