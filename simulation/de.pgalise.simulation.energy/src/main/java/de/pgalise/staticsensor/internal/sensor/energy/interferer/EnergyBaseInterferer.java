...
/**
 * Abstract super class for energy interferers
 * 
...
public abstract class EnergyBaseInterferer implements EnergyInterferer {
	 ...
	 */
	public EnergyBaseInterferer(RandomSeedService randomseedservice, String filepath) {
		...
		this.random = new Random(this.randomservice.getSeed(EnergyBaseInterferer.class.getName()));

		// Read property file
		try (InputStream propInFile = EnergyBaseInterferer.class.getResourceAsStream(filepath)) {
