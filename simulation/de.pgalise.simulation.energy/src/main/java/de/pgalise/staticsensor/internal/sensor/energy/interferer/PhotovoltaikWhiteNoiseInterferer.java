 ...
 */
public class PhotovoltaikWhiteNoiseInterferer extends EnergyBaseInterferer {

	/**
	 * File path for property file
	 */
	public static final String PROPERTIES_FILE_PATH = "/interferer_photovoltaik_whitenoise.properties";
	 ...
	 *            Random Seed Service
	 */
	public PhotovoltaikWhiteNoiseInterferer(RandomSeedService randomseedservice) {
		super(randomseedservice, PhotovoltaikWhiteNoiseInterferer.PROPERTIES_FILE_PATH);
	}
