...
public class SensorHelperWindPower extends SensorHelper {
	 ...
	 * @param nodeId
	 */
	public SensorHelperWindPower(Sensor<?> sensorID, Coordinate position, double activityValue, double rotorLength,
			List<SensorInterfererType> sensorInterfererList) {
		super(sensorID, position, EnergySensorTypeEnum.WINDPOWERSENSOR, sensorInterfererList);
	 ...
	 */
	public SensorHelperWindPower(Sensor<?> sensorID, Coordinate position, double activityValue, double rotorLength,
			int updateSteps, List<SensorInterfererType> sensorInterfererList) {
		this(sensorID, position, activityValue, rotorLength, sensorInterfererList);
