...
public class BuildingController implements Serializable {
	...
	@EJB
	private de.pgalise.simulation.controlCenter.internal.BuildingFacade ejbFacade;
	...
	public String prepareView() {
		current = (Building) getItems().getRowData();
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Building) {
				...
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Building.class.
					getName());
			}
		}
