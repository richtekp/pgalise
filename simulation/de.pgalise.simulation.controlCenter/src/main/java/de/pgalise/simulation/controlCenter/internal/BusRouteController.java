...
@ManagedBean(name = "busRouteController")
@SessionScoped
public class BusRouteController implements Serializable {

	private BusRoute current;
	private DataModel items = null;
	@EJB
	private de.pgalise.simulation.controlCenter.internal.BusRouteFacade ejbFacade;
	...
	private BusRouteFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (BusRoute) getItems().getRowData();
	...
	@FacesConverter(forClass = BusRoute.class)
	public static class BusRouteControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			BusRouteController controller = (BusRouteController) facesContext.
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof BusRoute) {
				BusRoute o = (BusRoute) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + BusRoute.class.
					getName());
			}
		}
