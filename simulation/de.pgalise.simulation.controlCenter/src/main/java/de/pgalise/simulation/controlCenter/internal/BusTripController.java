...
@ManagedBean(name = "busTripController")
@SessionScoped
public class BusTripController implements Serializable {

	private BusTrip current;
	private DataModel items = null;
	@EJB
	private de.pgalise.simulation.controlCenter.internal.BusTripFacade ejbFacade;
	...
	public BusTrip getSelected() {
		if (current == null) {
			current = new BusTrip(null,
				null,
				null,
				null,
				null,
	...
	private BusTripFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (BusTrip) getItems().getRowData();
	...
	@FacesConverter(forClass = BusTrip.class)
	public static class BusTripControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			BusTripController controller = (BusTripController) facesContext.
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof BusTrip) {
				BusTrip o = (BusTrip) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + BusTrip.class.
					getName());
			}
		}
