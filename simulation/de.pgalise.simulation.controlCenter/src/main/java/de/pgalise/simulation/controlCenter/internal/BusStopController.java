...
@ManagedBean(name = "busStopController")
@SessionScoped
public class BusStopController implements Serializable {

	private BusStop current;
	private DataModel items = null;
	@EJB
	private de.pgalise.simulation.controlCenter.internal.BusStopFacade ejbFacade;
	...
	private BusStopFacade getFacade() {
		return ejbFacade;
	}
	...
	public String prepareView() {
		current = (BusStop) getItems().getRowData();
	...
	@FacesConverter(forClass = BusStop.class)
	public static class BusStopControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			BusStopController controller = (BusStopController) facesContext.
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof BusStop) {
				BusStop o = (BusStop) object;
				return getStringKey(o.getId());
			} else {
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + BusStop.class.
					getName());
			}
		}
