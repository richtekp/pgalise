...
public class CityController implements Serializable {
	...
	@EJB
	private de.pgalise.simulation.controlCenter.internal.CityFacade ejbFacade;
	...
	public static class CityControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			CityController controller = (CityController) facesContext.getApplication().
				getELResolver().
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof City) {
				...
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + City.class.
					getName());
			}
		}
