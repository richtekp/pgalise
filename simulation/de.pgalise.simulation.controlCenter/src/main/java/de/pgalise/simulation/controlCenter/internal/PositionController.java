...
public class PositionController implements Serializable {
	...
	@EJB
	private de.pgalise.simulation.controlCenter.internal.PositionFacade ejbFacade;
	...
	public static class PositionControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			PositionController controller = (PositionController) facesContext.
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Position) {
				...
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Position.class.
					getName());
			}
		}
