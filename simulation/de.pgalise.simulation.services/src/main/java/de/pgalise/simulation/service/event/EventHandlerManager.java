...
/**
 * The EventHandlerManager manages several EventHandler loaded on initialization.
 * Each EventHandler listens for a particular type of event.
 * When the EventHandlerManager is told to process an event it looks for 
 * the appropriate EventHandler and informs it.
 * 
 * @see EventHandler
 * 
 * @param <H> type of the EventHandler that are managed by this EventHandlerManager
...
public interface EventHandlerManager<H extends EventHandler<E, T>, E extends Event<T>, T extends EventType> extends Iterable<H> {
	 ...
	 * @param clazz
	 *            if specified the paramater's class loader will be used to load the event handlers
	 * @throws ClassNotFoundException
	 *             if a handler could not be found
	 * @throws InstantiationException
	 *             if a handler could not be instantiated
	 * @throws IllegalAccessException
	 *             if a handler could not be accessed
	 * @throws IOException
	 ...
	 * 
	 * @param handler
	 *            EventHandler to be registered on this EventHandlerManager
	 */
	 ...
	 * 
	 * @param event
	 *            the SimulationEvent to be handled
	 */
