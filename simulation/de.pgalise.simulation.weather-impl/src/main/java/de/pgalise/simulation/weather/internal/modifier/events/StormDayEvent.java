...
public class StormDayEvent extends WeatherDayEventModifier {
   ...
   * @param weatherLoader
   */
  public StormDayEvent(City city,
    long seed,
    long time,
    Properties props,
    Float value,
  ...
  public void deployChanges() {
    ...
    StormDayEvent.log.debug("Max. value of event (" + max.getMeasureTime().
  ...
  protected void initDecorator() {
    if (this.getProps() != null) {
      ...
      this.min_value = Float.parseFloat(this.getProps().getProperty(
        "stormday_min_value"));
