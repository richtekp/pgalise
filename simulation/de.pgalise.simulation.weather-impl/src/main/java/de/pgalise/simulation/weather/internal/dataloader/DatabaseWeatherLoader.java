...
public class DatabaseWeatherLoader implements WeatherLoader {
  ...
  public ServiceDataCurrent loadCurrentServiceWeatherData(long timestamp,
    ...
    ServiceDataCurrent weather = new ServiceDataCurrent(idGenerator.getNextId(),
      data.getMeasureDate(),
      data.getMeasureTime(),
      data.getCity(),
  ...
  public ServiceDataForecast loadForecastServiceWeatherData(long timestamp,
    ...
    this.entityManager.merge(city.getBoundary().getReferencePoint());
    ...
    // Copy informations to the weather object
    ServiceDataForecast weather = new ServiceDataForecast(idGenerator.
      getNextId(),
      data.getMeasureDate(),
      data.getMeasureTime(),
      data.getCity(),
