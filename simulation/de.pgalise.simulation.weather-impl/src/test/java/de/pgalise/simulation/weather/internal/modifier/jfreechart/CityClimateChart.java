...
public class CityClimateChart extends AbstractChartTest {
	...
	public static void main(String[] args) throws Exception {
		...
		cal.set(2010, 7, 12, 0, 0, 0);
		long startTimestamp = cal.getTimeInMillis();

		// End
		cal.set(2010, 7, 13, 0, 0, 0);
		...
		// Test class
		AbstractChartTest chart = new CityClimateChart(startTimestamp, endTimestamp, parameter);
	 ...
	 */
	public CityClimateChart(long startdate, long enddate, WeatherParameterEnum parameter) throws Exception {
