 ...
 */
@Stateless
public class TrafficLightSensorDataFacade extends AbstractFacade<TrafficLightSensorData> {
	...
	public TrafficLightSensorDataFacade() {
		super(TrafficLightSensorData.class);
	}
