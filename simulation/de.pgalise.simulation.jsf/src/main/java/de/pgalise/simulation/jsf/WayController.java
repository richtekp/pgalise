...
@ManagedBean(name = "wayController")
@SessionScoped
public class WayController implements Serializable {

	private Way current;
	private DataModel items = null;
	@EJB
	private de.pgalise.simulation.jsf.WayFacade ejbFacade;
	...
	public Way getSelected() {
		if (current == null) {
			current = new Way(null,
				null);
			selectedItemIndex = -1;
		}
		return current;
	...
	public String prepareView() {
		current = (Way) getItems().getRowData();
	...
	@FacesConverter(forClass = Way.class)
	public static class WayControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext,
			...
			WayController controller = (WayController) facesContext.getApplication().
				getELResolver().
		...
		public String getAsString(FacesContext facesContext,
			...
			if (object instanceof Way) {
				...
				throw new IllegalArgumentException(
					"object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Way.class.
					getName());
			}
		}
