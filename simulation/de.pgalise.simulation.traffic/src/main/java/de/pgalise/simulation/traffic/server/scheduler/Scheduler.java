...
/**
 * The Scheduler used by the TrafficServer to schedule vehicles whose departure
 * times lie in the future. A schedule plan consists of two lists storing
 * expired Items and not expired Items. On every update step the TrafficServer
 * iterates through the expired items to update the vehicles that are already on
 * the road.
 *
 * @see Item
 * @see Administration
