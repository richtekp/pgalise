...
/**
 * The create busses event will create the given vehicles as busses for the
 * given routes.
 *
 * @param <D>
 * @author Lena
...
public class CreateBussesEvent<D extends VehicleData> extends AbstractTrafficEvent<D, CreateBussesEvent<D>> {
   ...
   * @param createRandomVehicleDataList List with busses
   * @param elaspsedTime
   * @param time Timestamp
   * @param busRoutes List with bus routes
   */
  public CreateBussesEvent(
    TrafficControllerLocal<CreateBussesEvent<D>> responsibleServer,
    long time,
    long elaspsedTime,
    List<CreateRandomBusData> createRandomVehicleDataList,
  ...
  /**
   * @param createRandomVehicleDataList the createRandomVehicleDataList to set
   */
  protected void setCreateRandomVehicleDataList(
    List<CreateRandomBusData> createRandomVehicleDataList) {
    this.createRandomVehicleDataList = createRandomVehicleDataList;
  }
  ...
  public int hashCode() {
    ...
    result = prime * result + ((createRandomVehicleDataList == null) ? 0 : createRandomVehicleDataList.
      hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!createRandomVehicleDataList.equals(
      other.createRandomVehicleDataList)) {
      return false;
    }
