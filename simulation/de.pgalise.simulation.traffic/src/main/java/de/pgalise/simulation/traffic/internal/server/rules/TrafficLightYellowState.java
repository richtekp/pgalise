...
/**
 * This State is held by a TrafficLight when it is has become yellow (before it was green).
 * 
 * @author Marcus
 */
class TrafficLightYellowState extends TrafficLightState {
	 ...
	 * 
	 * @return the TrafficLightYellowState as an enum constant (TrafficLightStateEnum.YELLOW)
	 */
	@Override
	TrafficLightStateEnum getState() {
		return TrafficLightStateEnum.YELLOW;
