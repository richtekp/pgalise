 ...
 *
 * @TODO: The information is mostly GTFS related data. It is not sure for what
 * it is used.
 * @author Lena
 */
@Entity
public class BusTrip extends TrafficTrip {
  ...
  @ManyToOne
  private GTFSBusCalendar busCalendar;
   ...
   * @param busStops List with bus stops
   * @param stopTimes Map with bus stops and stop times
   * @param bus
   */
  public BusTrip(BusRoute route,
    String shortName,
    String longName,
    List<BusStop> busStops,
    HashMap<BusStop, BusStopTime> stopTimes,
    Vehicle<BusData> bus) {
    this.route = route;
  ...
  public GTFSBusCalendar getServiceId() {
    return busCalendar;
  }

  public void setServiceId(GTFSBusCalendar serviceId) {
