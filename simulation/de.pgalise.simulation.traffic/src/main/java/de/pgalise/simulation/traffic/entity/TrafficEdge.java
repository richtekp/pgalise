...
/**
 * represents an immutable edge in the {@link TrafficGraph}.
 * <tt>NavigationNode</tt>s of the edge are obliged to have
 * {@link NavigationNode#NODE_RADIUS} distance.
 *
 * @author richter
 */
@Entity
...
//	}
  ...
  public TrafficEdge(Long id,
    TrafficEdge oncomingTrafficEdge,
    double maxSpeed,
    Way<?, ?> way,
    boolean priorityRoad,
    boolean carsAllowed,
    boolean bicyclesAllowed,
  ...
  public void setOncomingTrafficEdgeReachable(
    boolean oncomingTrafficEdgeReachable) {
  ...
  /**
   *
   * @return the maximal speed on this edge or <code>null</code> is the value is
   * not set
   */
