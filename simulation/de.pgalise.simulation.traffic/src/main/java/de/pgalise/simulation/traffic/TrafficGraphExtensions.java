...
public interface TrafficGraphExtensions extends GraphExtensions {
  ...
  public boolean addSensor(final TrafficNode node,
    final StaticTrafficSensor<?> sensor);
   ...
   */
  public TrafficNode setTrafficRule(final TrafficNode node,
   ...
   *
   * @param edge NavigationEdge to check
   ...
   *
   * @param edge NavigationEdge to register the car on
   * @param from Start node of the given edge
   * @param to End node of the given edge
   ...
   *
   * @param edge NavigationEdge to unregister the car from
   * @param from Start node of the given edge
   * @param to End node of the given edge
