 ...
 * @param <T>
 */
public class AbstractControlCenterMessage<T> implements ControlCenterMessage<T> {
	 ...
	 */
	protected AbstractControlCenterMessage() {
	}
	 ...
	 *            Content
	 */
	public AbstractControlCenterMessage(T content) {
	 ...
	 *            Content
	 */
	public AbstractControlCenterMessage( MessageTypeEnum messageType, T content) {
		this(	content);
