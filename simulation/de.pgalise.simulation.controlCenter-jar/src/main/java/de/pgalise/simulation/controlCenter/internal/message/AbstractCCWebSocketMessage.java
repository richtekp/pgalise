 ...
 * @param <T>
 */
public class AbstractCCWebSocketMessage<T> implements CCWebSocketMessage<T> {
	 ...
	 */
	protected AbstractCCWebSocketMessage() {
	}
	 ...
	 *            Content
	 */
	public AbstractCCWebSocketMessage(T content) {
	 ...
	 *            Content
	 */
	public AbstractCCWebSocketMessage( MessageTypeEnum messageType, T content) {
		this(	content);
