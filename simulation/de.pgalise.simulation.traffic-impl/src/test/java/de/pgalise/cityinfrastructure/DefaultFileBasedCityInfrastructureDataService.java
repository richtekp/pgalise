...
public class DefaultFileBasedCityInfrastructureDataService {
  ...
  public void setUp() throws Exception {
    ...
    osmParser.parse(DefaultFileBasedCityInfrastructureDataService.class.
      ...
      DefaultFileBasedCityInfrastructureDataService.class.getResourceAsStream(
        "/stops.txt"));
  }
  ...
  public void getNearestNodeTest() {
    ...
    NavigationNode givenNode = osmParser.createCityInfrastructureData().
      getNodes().get(
        (int) (Math.random() * osmParser.createCityInfrastructureData().
        getNodes().size()));
  ...
  public void testBusStops() {
    ...
    outerLoop:
    for (Way<?, ?> way : osmParser.createCityInfrastructureData().
      getMotorWaysWithBusStops()) {
  ...
  public void getBuildingsInRadiusTest() {
    ...
    NavigationNode tmpNode = osmParser.createCityInfrastructureData().getNodes().
      get(
        (int) (Math.random() * osmParser.createCityInfrastructureData().
        getNodes().size()));
  ...
  public void getNearestStreetNode() {
    ...
    for (NavigationNode node : osmParser.createCityInfrastructureData().
      getNodes()) {
