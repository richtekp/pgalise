 ...
 */
@Entity
public class DefaultBusRoute extends AbstractIdentifiable implements BusRoute<DefaultBusTrip> {
	/**
	 * Serial
	 */
	...
	private List<DefaultBusTrip> weekdayTripWayThere;
	private List<DefaultBusTrip> weekdayTripWayBack;
	private List<DefaultBusTrip> weekendTripWayThere;
	private List<DefaultBusTrip> weekendTripWayBack;

	/**
	 * Default constructor
	 */
	protected DefaultBusRoute() {
	}

	public DefaultBusRoute(String routeShortName,
	...
	public DefaultBusRoute(String routeShortName, String routeLongName, int routeType) {
		this(routeShortName,
			routeLongName,
			routeType,
			true);
	 ...
	 *            Route type
	 */
	public DefaultBusRoute(String routeShortName, String routeLongName, int routeType, boolean used) {
		this.routeShortName = routeShortName;
		this.routeLongName = routeLongName;
		this.routeType = routeType;
		this.used = used;
	 ...
	 */
	public List<DefaultBusTrip> getWeekdayTripWayThere() {
	 ...
	 */
	public void setWeekdayTripWayThere(List<DefaultBusTrip> weekdayTripWayThere) {
	 ...
	 */
	public List<DefaultBusTrip> getWeekdayTripWayBack() {
	 ...
	 */
	public void setWeekdayTripWayBack(List<DefaultBusTrip> weekdayTripWayBack) {
	 ...
	 */
	public List<DefaultBusTrip> getWeekendTripWayThere() {
	 ...
	 */
	public void setWeekendTripWayThere(List<DefaultBusTrip> weekendTripWayThere) {
	 ...
	 */
	public List<DefaultBusTrip> getWeekendTripWayBack() {
	 ...
	 */
	public void setWeekendTripWayBack(List<DefaultBusTrip> weekendTripWayBack) {
