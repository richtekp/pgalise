 ...
 */
public class XMLTruckFactory extends XMLAbstractFactory<TruckData> implements TruckFactory<DefaultTrafficNode<TruckData>,DefaultTrafficEdge<TruckData>, BaseVehicle<TruckData>> {
