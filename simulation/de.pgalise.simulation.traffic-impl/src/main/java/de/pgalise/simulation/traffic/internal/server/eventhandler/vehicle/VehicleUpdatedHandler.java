 ...
 * @author marcus
 */
public class VehicleUpdatedHandler extends AbstractVehicleEventHandler<VehicleData, VehicleEvent> {

  public VehicleUpdatedHandler() {
  }

  @Override
  public VehicleEventTypeEnum getTargetEventType() {
    return VehicleEventTypeEnum.VEHICLES_UPDATED;
  }
