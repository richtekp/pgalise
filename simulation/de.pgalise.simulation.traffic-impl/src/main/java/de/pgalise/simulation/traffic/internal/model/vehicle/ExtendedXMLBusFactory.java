...
public class ExtendedXMLBusFactory extends XMLAbstractFactory<BusData> implements BusFactory<DefaultTrafficNode<BusData>,DefaultTrafficEdge<BusData>, BaseVehicle<BusData>> {
	 ...
	 */
	public ExtendedXMLBusFactory(RandomSeedService randomSeedService, Document document,
	 ...
	 *            Random Seed Service
	 */
	public ExtendedXMLBusFactory(RandomSeedService randomSeedService, InputStream stream,
			TrafficGraphExtensions trafficGraphExtensions) {
