...
public class ExtendedXMLCarFactory extends XMLAbstractFactory<CarData> implements CarFactory {
	 ...
	 */
	public ExtendedXMLCarFactory(RandomSeedService randomSeedService, Document document,
	 ...
	 *            Random Seed Service
	 */
	public ExtendedXMLCarFactory(RandomSeedService randomSeedService, InputStream stream,
			TrafficGraphExtensions trafficGraphExtensions) {
