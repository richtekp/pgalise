 ...
 * @version 1.1
 */
public class DefaultRouteConstructor<D extends VehicleData> implements RouteConstructor<D, DefaultTrafficNode<D>, DefaultTrafficEdge<D>, BaseVehicle<D>, DefaultBusStop> {
