...
public class ExtendedXMLTruckFactory extends XMLAbstractFactory<TruckData> implements TruckFactory {
	 ...
	 */
	public ExtendedXMLTruckFactory(RandomSeedService randomSeedService, Document document,
	 ...
	 *            Random Seed Service
	 */
	public ExtendedXMLTruckFactory(RandomSeedService randomSeedService, InputStream stream,
			TrafficGraphExtensions trafficGraphExtensions) {
