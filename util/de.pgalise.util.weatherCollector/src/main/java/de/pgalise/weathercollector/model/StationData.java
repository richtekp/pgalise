...
@NamedQueries({
		@NamedQuery(name = "StationData.findByDateAndTime", query = "SELECT i FROM StationData i WHERE i.measureDate = :date AND i.measureTime = :time"),
		@NamedQuery(name = "StationData.findLastData", query = "SELECT i FROM StationData i ORDER BY i.measureDate DESC, i.measureTime DESC"), })
public final class StationData implements Comparable<StationData> {
	...
	public boolean equals(Object obj) {
		...
		} else if (!this.measureDate.equals(other.measureDate)) {
			return false;
		}
		...
		} else if (!this.measureTime.equals(other.measureTime)) {
			return false;
		}
		return true;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = (prime * result) + ((this.measureDate == null) ? 0 : this.measureDate.hashCode());
		result = (prime * result) + ((this.measureTime == null) ? 0 : this.measureTime.hashCode());
		return result;
	}
